...
export default class BestwayConditionalRendering extends Component {
    // PROPERTY CỦA CLASS
    state = {
        persons: [
            { name: 'Tú', age: 24 },
    ...
    //RENDER() FUNCTION SẼ TRẢ VỀ JSX
    render() { //trước lệnh return thì sẽ là JS, nên là vẫn xài JS if..else ở đây được
        let personUI = null;
        ...
        return (
            <div>
                <hr/>
                <h1>Best way Rendering Content Conditionally</h1>
